...
public class @PlayerControlls : IInputActionCollection, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""PlayerMovement"",
            ""id"": ""aaec4dd5-cb82-45f8-867d-58cb1f1c5003"",
            ""actions"": [
                {
                    ""name"": ""MoveRight"",
                    ""type"": ""Button"",
                    ""id"": ""ba814754-3853-407e-8866-bea7b227d615"",
                ...
                },
                {
                    ""name"": ""MoveLeft"",
                    ""type"": ""Button"",
                    ""id"": ""423d6190-8781-4a2a-bc9d-a303ffcf8f83"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                },
                {
                    ""name"": ""Duck"",
                    ""type"": ""Button"",
                    ""id"": ""3e65188e-3977-4cc5-a172-8d300b4f83d6"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                },
                {
                    ""name"": ""Jump"",
                    ""type"": ""Button"",
                    ""id"": ""58e3aa74-c623-4182-b0c9-6c207485ae17"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                },
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""bcca7ffa-1967-48b7-aaca-a2e3316aae13"",
                ...
                {
                    ""name"": """",
                    ""id"": ""2c61e528-eca7-4915-b7ec-bf998d995ba2"",
                ...
                {
                    ""name"": """",
                    ""id"": ""12be76fd-60fa-40c3-937a-1a8cd279d5b5"",
                    ""path"": ""<Keyboard>/d"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""12029681-cb71-4d01-991f-ab1786af843a"",
                ...
                {
                    ""name"": """",
                    ""id"": ""8a253cb7-90d6-4de4-bec9-2abe3819df4c"",
                ...
                {
                    ""name"": """",
                    ""id"": ""8647a272-fdeb-4743-8cb0-7a2d2a358221"",
                    ""path"": ""<Keyboard>/a"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""53b8b555-2905-4ba0-b7c3-d752d0676686"",
                ...
                {
                    ""name"": """",
                    ""id"": ""98b1fd3e-ef01-4080-ae4f-fd091063d743"",
                ...
                {
                    ""name"": """",
                    ""id"": ""022a8422-22c9-462d-9eb0-2ec799382b17"",
                    ""path"": ""<Keyboard>/s"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""79391aea-733f-4c0a-a554-2382204de169"",
                ...
                {
                    ""name"": """",
                    ""id"": ""80c81ddf-f24d-4d60-8677-3ab458123395"",
                ...
                {
                    ""name"": """",
                    ""id"": ""9b5ee6af-bdf7-4e8f-b04e-2575e5c38db7"",
                    ""path"": ""<Keyboard>/w"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    public struct PlayerMovementActions
    {
        ...
        public void SetCallbacks(IPlayerMovementActions instance)
        {
            if (m_Wrapper.m_PlayerMovementActionsCallbackInterface != null)
            {
                ...
                @Duck.started -= m_Wrapper.m_PlayerMovementActionsCallbackInterface.OnDuck;
                @Duck.performed -= m_Wrapper.m_PlayerMovementActionsCallbackInterface.OnDuck;
                @Duck.canceled -= m_Wrapper.m_PlayerMovementActionsCallbackInterface.OnDuck;
